...
function About(){
    return(
        <>
        <div id="about" className=" flex flex-col md:flex-row items-center gap-10 pt-30 md:pl-30 md:pr-30 text-2xl text-[#d3d3d3] ">
            <div id="abt-txt" className="flex-col space-y-5 w-3/4 "> 
                ...
                <p className=" hidden md:flex">Outside of coding, I enjoy activities that keep me curious and balanced — playing chess to sharpen my strategic thinking, listening to music to relax and stay inspired, and playing cricket for teamwork and focus. These hobbies help me stay creative and disciplined both inside and outside the tech world.</p>
                <p className=" hidden md:flex">If you’d like to connect or learn more about my work, feel free to reach out on <span className=' text-[#FFB606]'>LinkedIn </span>or check out my projects on GitHub. I’m always open to discussions, collaborations, and new opportunities to learn and grow.</p>
            </div> 
            <div id="abt-imp" className="hidden md:flex text-amber-50  outline-4  shadow-[0_0_40px_#d6af53]  outline-[#FFB606] w-1/4">
