...
function Footer(){
    return (
       <div className=" flex flex-col justify-between items-center pt-8 bg-linear-to-b from-[#1A1A1A] to-[#605b5b] border-t-2  border-amber-300  h-100">
                ...
                <div id="lower-part" className=" flex  pb-0 p-10  mb-5 w-full justify-between text-xl ">
                    <div id="bottom-left" className="flex gap-2.5 ">
                        <p className=" text-xl font-thin">Developed By </p>  
                            <a href="https://www.linkedin.com/in/anuj-pundora-b21973265/"
